...
import org.sathyatech.onlineshopping12.exception.ProductNotFoundExcpetion;
...
public class PageController {
	...
	public ModelAndView showSingleProduct(@PathVariable int id) throws ProductNotFoundExcpetion{
		ModelAndView mv=new ModelAndView("page");
